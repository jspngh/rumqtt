...
impl FixedHeader {
    ...
    /// Alias for [`Self::packet_size`].
    #[inline]
    #[deprecated(note = "Renamed to `packet_size`")]
    ...
    pub fn check(stream: Iter<u8>, max_packet_size: usize) -> Result<Self, Error> {
        ...
        if fixed_header.remaining_len > max_packet_size {
            return Err(Error::PayloadSizeLimitExceeded {
                ...
                max: max_packet_size as u32, // TODO
            });
        }
